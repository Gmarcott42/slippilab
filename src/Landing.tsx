...
export function Landing() {
  return (
    <div
      className="box-border grid h-screen bg-[length:30px_30px] p-4"
      style={{
        gridTemplateAreas: `
          ".      .      ."
          "falco  logo   fox"
        ...
        `,
        gridTemplateRows: "1fr auto 1fr max-content",
    ...
    >
      <div style={{ gridArea: "falco" }}>
        <svg className="aspect-square" viewBox="-14 -20 30 19">
          <radialGradient id="fill-red" r="1">
            <stop stopColor={colors.red["700"]}>
              <animate
                dur="0.5s"
                begin="1.35s"
          ...
          <path
            ...
            className="flex-grow animate-draw stroke-red-800 stroke-[3]"
      ...
      >
        <div className="flex flex-col items-center">
          ...
          <div className="w-max font-['Comfortaa-Bold'] text-6xl tracking-tighter">
            Slippi Lab
          </div>
        </div>
        <OpenMenu name="Start" />
      </div>
      <div style={{ gridArea: "fox" }}>
        <svg className="aspect-square" viewBox="-16 -24 30 29">
          <radialGradient id="fill-blue" r="1">
            <stop stopColor={colors.blue["700"]}>
              <animate
                dur="0.5s"
                begin="1.35s"
                attributeName="offset"
          ...
          <path
            transform="scale(-.1 .1) translate(-500 -500)"
            className="animate-draw stroke-blue-800 stroke-[3]"
            strokeDasharray="1000"
            fill="url(#fill-blue)"
            strokeDashoffset="1000"
      ...
      >
        ...
        <div>
          ...
          <a
            ...
            className="cursor-pointer pl-[0.5ch] text-slippi-500 underline"
